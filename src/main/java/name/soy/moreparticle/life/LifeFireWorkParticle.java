...
public class LifeFireWorkParticle extends AnimatedParticle {
	...
	private LifeFireWorkParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider, LifeEffect effect) {
	...
	public static class Factory implements ParticleFactory<LifeEndRodEffect> {
		...
		public Particle createParticle(LifeEndRodEffect effect, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
			return new LifeFireWorkParticle(clientWorld, d, e, f, g, h, i, this.spriteProvider, effect);
		}
	}
}
